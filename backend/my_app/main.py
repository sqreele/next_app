# ==============================================================================
# File: backend/my_app/main.py (Updated to use sync engine for SQLAdmin)
...
from my_app.database import engine as async_engine, sync_engine, Base, SQLALCHEMY_DATABASE_URL
...
# *** UPDATED: Use sync_engine for SQLAdmin ***
...
admin.add_view(ProcedureAdmin)  # This should now work properly
